# Capability: DB Migration

## Purpose

Ensures database schema migrations are applied safely, preserving existing data without loss and following a structured process for destructive or non-nullable changes.
